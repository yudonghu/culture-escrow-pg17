...
async def pg17_fill(
    ...
    counter_offer_numbers: Optional[str] = Form(default=""),    # seller counter offer
    buyer_counter_offer: Optional[str] = Form(default=""),      # buyer counter offer
    ...
    fields = FillFields(
        ...
        counter_offer_numbers=(counter_offer_numbers or "").strip(),
        buyer_counter_offer=(buyer_counter_offer or "").strip(),
